...
import stepdefinitions.utilities.ConfigurationReader;
import stepdefinitions.utilities.Driver;
...
//         It will wait when needed as well
        string=faker.idNumber().ssnValid();//override and assign it        Driver.waitAndSendText(registrationPage.ssnTextbox,string);
    }
